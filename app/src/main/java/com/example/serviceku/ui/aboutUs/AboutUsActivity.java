package com.example.serviceku.ui.aboutUs;
...
public class AboutUsActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    private void enableLocationComponent(Style style) {
        if (PermissionsManager.areLocationPermissionsGranted(this)) {
            LocationComponentOptions locationComponentOptions = LocationComponentOptions.
                    builder(this).pulseEnabled(true).build();
